      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-evenly space-y-6 md:space-y-0 relative z-10">
        ...
        <div className="text-center md:text-left">
          <p className="text-lg md:text-xl font-light">
            ...
            <span className="text-2xl md:text-3xl font-semibold font-Sacramento text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">
              {" "}
              Saurav G.C.
            </span>
          </p>
          <p className="text-sm md:text-md opacity-80 mt-2">
            Click on the home page grid for
